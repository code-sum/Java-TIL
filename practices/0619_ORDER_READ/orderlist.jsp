...
<script type="text/javascript">
	...
	function popupinit(object) {
        ...
        $("#clnt_name").val(object.clnt_name);  // 회사이메일
        $("#clnt_name").val(object.clnt_name);  // 우편번호
        $("#clnt_name").val(object.clnt_name);  // 주소
        $("#clnt_name").val(object.clnt_name);  // 상세주소
        */
	...
	function fn_selectone(no) {
		...
		var selectoncallback = function(returndata) {			
	        ...
	        popupinit(returndata.ordersearch);
	    ...
	    callAjax("/busOdm/orderselectone.do", "post", "json", false, param, selectoncallback);		
	}
				...
				<li class="contents">
					...
					<div class="content">
						...
						<div style="display:flex; justify-content:center; align-content:center; line-height:2; border:1px solid DeepSkyBlue; padding:40px 40px; margin-bottom: 8px;">
							...
							<select id="clicombo" name="clicombo" style="width:150px; margin-right:50px;" ></select>
							 							
							<label for="start" style="font-size:15px; font-weight:bold; margin-right:10px;">주문날짜</label>
							<input type="date" id="start" name="start" min="2023-01-01" style="height:auto; width:100px; margin-right:5px;">
							<span style="margin-right:5px; line-height:3;"> ~ </span>
							<input type="date" id="end" name="end" min="2023-01-01" style="height:auto; width:100px; margin-right:50px;">
				...
				<table class="row">
					...
					<tbody>
						<tr>
							...
							<td><input type="text" class="inputTxt p100" id="order_no" name="order_no" /></td>
							<th scope="row">주문날짜</th>
							<td><input type="text" class="inputTxt p100" id="order_date" name="order_date" /></td>
						</tr>
						<tr>
							<th scope="row">주문기업명</th>
							<td><input type="text" class="inputTxt p100" id="clnt_name" name="clnt_name" /></td>
							<th scope="row">회사전화</th>
							<td><input type="text" class="inputTxt p100" id="clnt_tel" name="clnt_tel" /></td>
						</tr>
						<tr>
							<th scope="row">회사이메일</th>
							<td><input type="text" class="inputTxt p100" id="dtl_cod" name="dtl_cod" /></td>
							<th scope="row">영업담당자</th>
							<td><input type="text" class="inputTxt p100" id="name" name="name" /></td>
						</tr>
